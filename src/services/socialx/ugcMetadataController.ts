...
/** queryUgcArticleTagWithCursor GET /api/ugc/metadata/article-tag */
...
/** queryUgcInterestTag GET /api/ugc/metadata/interest-tag */
export async function queryUgcInterestTagUsingGet(options?: { [key: string]: any }) {
  return request<API.ResultUgcMetadataResponse_>('/api/ugc/metadata/interest-tag', {
    method: 'GET',
    ...(options || {}),
  });
}
